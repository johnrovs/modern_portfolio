    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
        ...
        >
          ...
          <p className="font-mono text-accent text-sm sm:text-base mb-3">
            Hi, I'm
          </p>
          <h1 className="font-heading font-extrabold text-4xl sm:text-5xl lg:text-6xl leading-tight text-textPrimary">
          ...
          <div className="mt-4 h-10 sm:h-12 font-display text-xl sm:text-2xl lg:text-3xl text-textSecondary flex items-center">
            <span className="text-textPrimary/90">{typed}</span>
          ...
          <p className="mt-6 max-w-xl text-textSecondary text-base sm:text-lg leading-relaxed">
            I build scalable, high-performance web applications with Java,
        ...
        >
          <div className="gradient-border overflow-hidden animate-glow rounded-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.35)] bg-ink/90 backdrop-blur-xl">
            {/* window chrome */}
            ...
            <div className="p-6 sm:p-8 font-mono text-sm sm:text-base leading-relaxed">
              ...
              {["Java", "Spring Boot", "React", "MySQL"].map((t) => (
            ...
            <div className="absolute -bottom-6 -right-6 sm:-bottom-8 sm:-right-8">
              ...
              >
                <img
                  ...
                  className="w-full h-full object-cover rounded-2xl border-2 border-ink"
                  loading="eager"
                />
              </motion.div>
            </div>
      ...
      <motion.button
        ...
        className="hidden sm:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-2 text-textSecondary/70 hover:text-textPrimary transition-colors"
