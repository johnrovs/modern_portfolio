    ...
    <AnimatePresence>
      {cert && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between gap-4 px-5 sm:px-6 py-4 border-b border-overlay/10 shrink-0">
              <div className="min-w-0">
                <h3 className="font-heading font-semibold text-textPrimary truncate">{cert.title}</h3>
              ...
              <div className="flex items-center gap-2 shrink-0">
                <a
                  ...
                  className="w-9 h-9 rounded-full glass flex items-center justify-center text-textSecondary hover:text-textPrimary hover:border-accent/60 transition-colors"
                >
            ...
            {/* PDF preview */}
            <div className="relative flex-1 min-h-[60vh] bg-ink">
              {!failed ? (
                <iframe
                  key={cert.pdf}
            ...
            <p className="sm:hidden px-5 py-3 text-xs text-textSecondary/60 border-t border-overlay/10 text-center">
