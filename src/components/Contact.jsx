      ...
      <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-16">
        <div>
          ...
          <p className="text-textSecondary text-base sm:text-lg leading-relaxed max-w-md -mt-6">
            Have a project in mind or an opening on your team? I'd love to hear
            about it — drop a message and I'll get back to you soon.
          </p>

          <div className="mt-8 space-y-4">
            <a
              href="mailto:roverorommel12@gmail.com"
              className="flex items-center gap-4 glass-card p-4 hover:border-accent/50 transition-colors"
            >
        ...
        >
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl bg-overlay/5 border ${
                errors.name ? "border-red-400/60" : "border-overlay/10"
              } text-textPrimary placeholder:text-textSecondary/50 focus:border-accent/60 outline-none transition-colors`}
            />
            {errors.name && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl bg-overlay/5 border ${
                errors.email ? "border-red-400/60" : "border-overlay/10"
              } text-textPrimary placeholder:text-textSecondary/50 focus:border-accent/60 outline-none transition-colors`}
            />
            {errors.email && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl bg-overlay/5 border ${
                errors.subject ? "border-red-400/60" : "border-overlay/10"
              } text-textPrimary placeholder:text-textSecondary/50 focus:border-accent/60 outline-none transition-colors`}
            />
            {errors.subject && (
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-4 py-3 rounded-xl bg-overlay/5 border ${
                errors.message ? "border-red-400/60" : "border-overlay/10"
              } text-textPrimary placeholder:text-textSecondary/50 focus:border-accent/60 outline-none transition-colors resize-none`}
            />
            {errors.message && (
